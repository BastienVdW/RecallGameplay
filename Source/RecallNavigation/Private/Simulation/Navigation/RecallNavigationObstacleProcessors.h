...
UCLASS()
class URecallNavigationObstacleInitializeProcessor : public UMassExtendedProcessor
{
	GENERATED_BODY()
...
UCLASS()
class URecallNavigationObstacleResetProcessor : public UMassExtendedProcessor
{
	GENERATED_BODY()
