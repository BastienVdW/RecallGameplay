...
UCLASS()
class URecallTemplateConstructor : public UMassExtendedObserverProcessor
{
	GENERATED_BODY()
...
UCLASS()
class URecallTemplateDestructor : public UMassExtendedObserverProcessor
{
	GENERATED_BODY()
...
UCLASS()
class URecallTemplateProcessor : public UMassExtendedProcessor
{
	GENERATED_BODY()
