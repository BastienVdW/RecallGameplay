...
#include "RecallStateTreeSchemaBase.generated.h"

/**
 * StateTree for Recall behaviors.
 */
UCLASS(EditInlineNew, CollapseCategories, meta=(DisplayName="RE Behavior Base", CommonSchema))
class RECALLGAMEPLAY_API URecallStateTreeSchemaBase : public UStateTreeSchema
{
	GENERATED_BODY()

public:
	URecallStateTreeSchemaBase();
...
private:
	...
	TStateTreeExternalDataHandle<struct FRecallTransformFragment> TransformFragment;
