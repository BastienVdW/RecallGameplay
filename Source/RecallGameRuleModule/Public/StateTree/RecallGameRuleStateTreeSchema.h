...
#include "RecallGameRuleStateTreeSchema.generated.h"

/**
 * StateTree for Game Rule behaviors.
 * Allows us to control the flow of the game.
 */
UCLASS(BlueprintType, EditInlineNew, CollapseCategories, meta=(DisplayName="RE Game Rule Behavior", CommonSchema))
class RECALLGAMERULEMODULE_API URecallGameRuleStateTreeSchema : public UStateTreeSchema
{
	GENERATED_BODY()

public:
	URecallGameRuleStateTreeSchema();
...
private:
	...
	TStateTreeExternalDataHandle<struct FRecallStateTreeInstanceFragment> StateTreeInstanceFragment;
};
