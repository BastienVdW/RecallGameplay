...
#include "RecallGameplayEffectProcessors.generated.h"

UCLASS()
class URecallGameplayEffectInitializer : public UMassExtendedObserverProcessor
{
	GENERATED_BODY()
...
UCLASS()
class URecallGameplayEffectTickProcessor : public UMassExtendedProcessor
{
	GENERATED_BODY()
