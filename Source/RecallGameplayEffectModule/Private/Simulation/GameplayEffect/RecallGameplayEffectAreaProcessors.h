...
#include "RecallGameplayEffectAreaProcessors.generated.h"

UCLASS()
class URecallGameplayEffectAreaSignalProcessor : public URecallSignalProcessorBase
{
	GENERATED_BODY()
	
public:
	URecallGameplayEffectAreaSignalProcessor(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
